  ...
  render() {
    return (
      <div id='appWrapper'>
        ...
        {this.state.showNav &&
          <div id='expandedNav'>
            <span id='closeNav' onClick={this.navClick}>
            ...
            <span id='navList'>
              ...
              <div>
                <a href='./Agenda.pdf' className='navLinkAgenda' target="_blank">Agenda</a>
              </div>
            </span>
          </div>
        }
{/*
        ...
        <div id='getTicketsContainer' className={this.state.showForm ? 'open': ''}>
          <a id='closeTicketBox' onClick={this.formClick}>
            <div className="closeModalBar1"></div>
            <div className="closeModalBar2"></div>
          </a>
          <div style={{width:100+'%', textAlign:'left', marginTop:'7%'}}><iframe src="//eventbrite.com/tickets-external?eid=36226627819&ref=etckt" frameBorder="0" height="308" width="100%" vspace="0" hspace="0" marginHeight="5" marginWidth="5" scrolling="auto" allowTransparency="true"></iframe><div style={{fontFamily:'Helvetica, Arial', fontSize:12 + 'px', padding: '10px 0 5px', margin: 2 +'px', width: 100+'%', textAlign:'left'}} ><a className="powered-by-eb" style={{color: '#ADB0B6', textDecoration: 'none'}} target="_blank" href="http://www.eventbrite.com/">Powered by Eventbrite</a></div></div>
        </div>
